...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Авг 20 2024 г., 18:44
...
INSERT INTO `deals` (`id`, `name`, `amount`, `contact_id`) VALUES
(1, 'Сделка 1', '10000.00', 2);
...
--
ALTER TABLE `deals`
  ADD CONSTRAINT `deals_ibfk_1` FOREIGN KEY (`contact_id`) REFERENCES `contacts` (`id`);
COMMIT;
